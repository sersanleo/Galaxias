...
public class InfoDialog extends JDialog {
	...
	private final Component tutorialPanel() {
		return htmlTextPane(
				"<h3>Crear o cargar una partida</h3> Para comenzar una nueva partida, hay que dirigirse al menú <b>Juego > Nuevo</b>, y seleccionar una de las dos opciones:<br> - <b>Generar tablero</b> te permite jugar a un tablero generado automáticamente introduciendo las dimensiones del mismo y su dificultad.<br> - <b>Crear tablero</b> te permite crear un tablero añadiendo visualmente las galaxias, introduciendo las dimensiones del mismo.<br> Si ya has guardado una partida con anterioridad, puedes cargar dicha partida en <b>Juego > Cargar partida</b>.<br> <h3>Jugar</h3> <center><img src='"
						+ imgSrc("game.png")
