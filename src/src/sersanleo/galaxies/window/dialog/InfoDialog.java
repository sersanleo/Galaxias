	...
	private final Component tutorialPanel() {
		return htmlTextPane(
				"<h3>Crear o cargar una partida</h3> Para comenzar una nueva partida, hay que dirigirse al menú <b>Juego > Nuevo</b>, y seleccionar una de las dos opciones:<br> - <b>Generar tablero</b> te permite jugar a un tablero generado automáticamente introduciendo las dimensiones del mismo y su dificultad.<br> - <b>Crear tablero</b> te permite jugar a un tablero generado automáticamente introduciendo las dimensiones del mismo y su dificultad.<br> Si ya has guardado una partida con anterioridad, puedes cargar dicha partida en <b>Juego > Cargar partida</b>.<br> <h3>Jugar</h3> <center><img src='"
						...
						+ imgSrc("ranking.png")
						+ "' /></center><br> El cuadro de honor aparecerá cuando completes un tablero, para introducir tu nombre junto con la puntuación conseguida. Puede accederse a él en cualquier momento en <b>Juego > Cuadro de honor</b> para consultar las puntuaciones guardadas.");
	}
}
